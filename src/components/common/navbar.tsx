        ...
        <div className="h-28 border-b-slate-100 border-b-[1px] flex items-center justify-center">
            <div className="lg:max-w-[70%] max-w-[80%] h-full w-full grid md:grid-cols-12 grid-cols-5">
                ...
                <span className="lg:col-span-6 col-span-8 hidden md:flex items-center justify-end">
                    ...
                    <button className='py-3 px-8 mx-2 bg-purple-900 border-2 border-purple-900 text-white font-DMSans rounded-full font-bold text-xs tracking-wider hover:bg-white hover:text-purple-900 transition-colors duration-300'>
                        Upload
                    </button>
                    <button className='py-3 px-8 mx-2 bg-purple-900 text-white border-2 border-purple-900 font-DMSans rounded-full font-bold text-xs tracking-wider whitespace-nowrap hover:bg-white hover:text-purple-900 transition-colors duration-300'>
                        Connect Wallet
                    </button>
                </span>
